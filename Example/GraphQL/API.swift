...
public final class SearchRepositoriesQuery: GraphQLQuery {
  public let operationDefinition =
    "query SearchRepositories($searchText: String!, $after: String) {\n  search(query: $searchText, after: $after, type: REPOSITORY, first: 10) {\n    __typename\n    repositoryCount\n    pageInfo {\n      __typename\n      endCursor\n      hasNextPage\n    }\n    edges {\n      __typename\n      node {\n        __typename\n        ... on Repository {\n          nameWithOwner\n          forkCount\n          stargazers {\n            __typename\n            totalCount\n          }\n        }\n      }\n    }\n  }\n}"

  public var searchText: String
  public var after: String?

  public init(searchText: String, after: String? = nil) {
    self.searchText = searchText
    self.after = after
  }

  public var variables: GraphQLMap? {
    return ["searchText": searchText, "after": after]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("search", arguments: ["query": GraphQLVariable("searchText"), "after": GraphQLVariable("after"), "type": "REPOSITORY", "first": 10], type: .nonNull(.object(Search.selections))),
    ]
    ...
    public struct Search: GraphQLSelectionSet {
      ...
      public struct Edge: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(nameWithOwner: String, forkCount: Int, stargazers: AsRepository.Stargazer) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "nameWithOwner": nameWithOwner, "forkCount": forkCount, "stargazers": stargazers.resultMap])
          }
          ...
          public struct AsRepository: GraphQLSelectionSet {
            ...
            public init(nameWithOwner: String, forkCount: Int, stargazers: Stargazer) {
              self.init(unsafeResultMap: ["__typename": "Repository", "nameWithOwner": nameWithOwner, "forkCount": forkCount, "stargazers": stargazers.resultMap])
            }
